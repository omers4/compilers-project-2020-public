...
loop21:
	...
	br label %andcond24
andcond24:
	br i1 %_8, label %andcond25, label %andcond27
andcond25:
...
andcond26:
	br label %andcond27
andcond27:
	%_11 = phi i32 [0, %andcond24], [%_10, %andcond26]
	br i1 %_11, label %loop22, label %loop23
loop22:
	%_12 = load i8*, i8** %e
	...
	br i1 %_19, label %if28, label %if29
if28:
	store i1 1, i1* %ret_val
	%_20 = load i32, i32* %aux04
	%_21 = icmp slt i32 %_20, 0
	br i1 %_21, label %if31, label %if32
if31:
...
if30:
	...
	%_46 = sub i1 1, %_45
	br i1 %_46, label %if34, label %if35
if34:
...
loop37:
	...
	%_7 = sub i1 1, %_6
	br i1 %_7, label %loop38, label %loop39
loop38:
	%_8 = load i8*, i8** %e
	...
	br i1 %_15, label %if40, label %if41
if40:
...
loop43:
	%_6 = load i1, i1* %var_end
	%_7 = sub i1 1, %_6
	br i1 %_7, label %loop44, label %loop45
loop44:

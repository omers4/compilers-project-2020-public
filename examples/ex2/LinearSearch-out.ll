...
loop7:
	...
	%_3 = load i32, i32* %_2
	%_4 = icmp slt i32 %_0, %_3
	br i1 %_4, label %loop8, label %loop9
loop8:
	%_5 = getelementptr i8, i8* %this, i32 8
	%_6 = bitcast i8* %_5 to i32**
	%_7 = load i32*, i32** %_6
	%_8 = load i32, i32* %j
	%_9 = icmp slt i32 %_8, 0
	br i1 %_9, label %arr_alloc10, label %arr_alloc11
arr_alloc10:
	call void @throw_oob()
...
arr_alloc11:
	...
	%_11 = load i32, i32* %_10
	%_12 = icmp sle i32 %_11, %_8
	br i1 %_12, label %arr_alloc12, label %arr_alloc13
arr_alloc12:
	call void @throw_oob()
...
arr_alloc13:
	...
	br i1 %_20, label %if14, label %if15
if14:
	store i32 0, i32* %nt
	br label %if16
if15:
	...
	%_24 = sub i1 1, %_23
	br i1 %_24, label %if17, label %if18
if17:
	store i32 0, i32* %nt
	br label %if19
if18:
...
define i32 @LS.Init(i8* %this, i32 %.sz) {
	...
	br i1 %_4, label %arr_alloc20, label %arr_alloc21
arr_alloc20:
	call void @throw_oob()
...
loop22:
	...
	br i1 %_18, label %loop23, label %loop24
loop23:
	%_19 = load i32, i32* %j
	%_20 = mul i32 2, %_19
	...
	br i1 %_30, label %arr_alloc25, label %arr_alloc26
arr_alloc25:
	call void @throw_oob()
...
arr_alloc26:
	...
	br i1 %_33, label %arr_alloc27, label %arr_alloc28
arr_alloc27:
	call void @throw_oob()

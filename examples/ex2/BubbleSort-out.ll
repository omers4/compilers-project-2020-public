...
loop33:
	...
	br i1 %_4, label %loop34, label %loop35
loop34:
	...
	br i1 %_9, label %arr_alloc36, label %arr_alloc37
arr_alloc36:
	call void @throw_oob()
...
arr_alloc37:
	...
	br i1 %_12, label %arr_alloc38, label %arr_alloc39
arr_alloc38:
	call void @throw_oob()
...
define i32 @BBS.Init(i8* %this, i32 %.sz) {
	...
	br i1 %_4, label %arr_alloc40, label %arr_alloc41
arr_alloc40:
	call void @throw_oob()
...
arr_alloc41:
	...
	br i1 %_13, label %arr_alloc42, label %arr_alloc43
arr_alloc42:
	call void @throw_oob()
...
arr_alloc43:
	...
	br i1 %_16, label %arr_alloc44, label %arr_alloc45
arr_alloc44:
	call void @throw_oob()
...
arr_alloc45:
	...
	br i1 %_22, label %arr_alloc46, label %arr_alloc47
arr_alloc46:
	call void @throw_oob()
...
arr_alloc47:
	...
	br i1 %_25, label %arr_alloc48, label %arr_alloc49
arr_alloc48:
	call void @throw_oob()
...
arr_alloc49:
	...
	br i1 %_31, label %arr_alloc50, label %arr_alloc51
arr_alloc50:
	call void @throw_oob()
...
arr_alloc51:
	...
	br i1 %_34, label %arr_alloc52, label %arr_alloc53
arr_alloc52:
	call void @throw_oob()
...
arr_alloc53:
	...
	br i1 %_40, label %arr_alloc54, label %arr_alloc55
arr_alloc54:
	call void @throw_oob()
...
arr_alloc55:
	...
	br i1 %_43, label %arr_alloc56, label %arr_alloc57
arr_alloc56:
	call void @throw_oob()
...
arr_alloc57:
	...
	br i1 %_49, label %arr_alloc58, label %arr_alloc59
arr_alloc58:
	call void @throw_oob()
...
arr_alloc59:
	...
	br i1 %_52, label %arr_alloc60, label %arr_alloc61
arr_alloc60:
	call void @throw_oob()
...
arr_alloc61:
	...
	br i1 %_58, label %arr_alloc62, label %arr_alloc63
arr_alloc62:
	call void @throw_oob()
...
arr_alloc63:
	...
	br i1 %_61, label %arr_alloc64, label %arr_alloc65
arr_alloc64:
	call void @throw_oob()
...
arr_alloc65:
	...
	br i1 %_67, label %arr_alloc66, label %arr_alloc67
arr_alloc66:
	call void @throw_oob()
...
arr_alloc67:
	...
	br i1 %_70, label %arr_alloc68, label %arr_alloc69
arr_alloc68:
	call void @throw_oob()
...
arr_alloc69:
	...
	br i1 %_76, label %arr_alloc70, label %arr_alloc71
arr_alloc70:
	call void @throw_oob()
...
arr_alloc71:
	...
	br i1 %_79, label %arr_alloc72, label %arr_alloc73
arr_alloc72:
	call void @throw_oob()
...
arr_alloc73:
	...
	br i1 %_85, label %arr_alloc74, label %arr_alloc75
arr_alloc74:
	call void @throw_oob()
...
arr_alloc75:
	...
	br i1 %_88, label %arr_alloc76, label %arr_alloc77
arr_alloc76:
	call void @throw_oob()
...
arr_alloc77:
	...
	br i1 %_94, label %arr_alloc78, label %arr_alloc79
arr_alloc78:
	call void @throw_oob()
...
arr_alloc79:
	...
	br i1 %_97, label %arr_alloc80, label %arr_alloc81
arr_alloc80:
	call void @throw_oob()

...
loop24:
	...
	br i1 %_6, label %loop25, label %loop26
loop25:
	...
	br i1 %_21, label %arr_alloc27, label %arr_alloc28
arr_alloc27:
	call void @throw_oob()
...
arr_alloc28:
	...
	br i1 %_24, label %arr_alloc29, label %arr_alloc30
arr_alloc29:
	call void @throw_oob()
...
arr_alloc30:
	...
	br i1 %_30, label %if31, label %if32
if31:
...
if33:
	...
	br i1 %_42, label %if34, label %if35
if34:
...
if36:
	...
	br i1 %_45, label %if37, label %if38
if37:
	store i1 0, i1* %var_cont
	br label %if39
if38:
...
loop26:
	...
	br i1 %_53, label %if40, label %if41
if40:
	store i1 1, i1* %bs01
	br label %if42
if41:
...
loop43:
	...
	br i1 %_4, label %loop44, label %loop45
loop44:
...
define i1 @BS.Compare(i8* %this, i32 %.num1, i32 %.num2) {
	...
	%_4 = icmp slt i32 %_2, %_3
	br i1 %_4, label %if46, label %if47
if46:
	store i1 0, i1* %retval
	br label %if48
if47:
	...
	%_8 = sub i1 1, %_7
	br i1 %_8, label %if49, label %if50
if49:
	store i1 0, i1* %retval
	br label %if51
if50:
...
loop52:
	...
	br i1 %_4, label %loop53, label %loop54
loop53:
	...
	br i1 %_9, label %arr_alloc55, label %arr_alloc56
arr_alloc55:
	call void @throw_oob()
...
arr_alloc56:
	...
	br i1 %_12, label %arr_alloc57, label %arr_alloc58
arr_alloc57:
	call void @throw_oob()
...
define i32 @BS.Init(i8* %this, i32 %.sz) {
	...
	br i1 %_4, label %arr_alloc59, label %arr_alloc60
arr_alloc59:
	call void @throw_oob()
...
loop61:
	...
	br i1 %_18, label %loop62, label %loop63
loop62:
	%_19 = load i32, i32* %j
	%_20 = mul i32 2, %_19
	...
	br i1 %_30, label %arr_alloc64, label %arr_alloc65
arr_alloc64:
	call void @throw_oob()
...
arr_alloc65:
	...
	br i1 %_33, label %arr_alloc66, label %arr_alloc67
arr_alloc66:
	call void @throw_oob()

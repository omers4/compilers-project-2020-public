...
loop69:
	...
	br i1 %_4, label %loop70, label %loop71
loop70:
	...
	br i1 %_9, label %arr_alloc72, label %arr_alloc73
arr_alloc72:
	call void @throw_oob()
...
arr_alloc73:
	...
	br i1 %_12, label %arr_alloc74, label %arr_alloc75
arr_alloc74:
	call void @throw_oob()
...
define i32 @QS.Init(i8* %this, i32 %.sz) {
	...
	br i1 %_4, label %arr_alloc76, label %arr_alloc77
arr_alloc76:
	call void @throw_oob()
...
arr_alloc77:
	...
	br i1 %_13, label %arr_alloc78, label %arr_alloc79
arr_alloc78:
	call void @throw_oob()
...
arr_alloc79:
	...
	br i1 %_16, label %arr_alloc80, label %arr_alloc81
arr_alloc80:
	call void @throw_oob()
...
arr_alloc81:
	...
	br i1 %_22, label %arr_alloc82, label %arr_alloc83
arr_alloc82:
	call void @throw_oob()
...
arr_alloc83:
	...
	br i1 %_25, label %arr_alloc84, label %arr_alloc85
arr_alloc84:
	call void @throw_oob()
...
arr_alloc85:
	...
	br i1 %_31, label %arr_alloc86, label %arr_alloc87
arr_alloc86:
	call void @throw_oob()
...
arr_alloc87:
	...
	br i1 %_34, label %arr_alloc88, label %arr_alloc89
arr_alloc88:
	call void @throw_oob()
...
arr_alloc89:
	...
	br i1 %_40, label %arr_alloc90, label %arr_alloc91
arr_alloc90:
	call void @throw_oob()
...
arr_alloc91:
	...
	br i1 %_43, label %arr_alloc92, label %arr_alloc93
arr_alloc92:
	call void @throw_oob()
...
arr_alloc93:
	...
	br i1 %_49, label %arr_alloc94, label %arr_alloc95
arr_alloc94:
	call void @throw_oob()
	br label %arr_alloc95
arr_alloc95:
	%_50 = getelementptr i32, i32* %_48, i32 0
	%_51 = load i32, i32* %_50
	%_52 = icmp sle i32 %_51, 4
	br i1 %_52, label %arr_alloc96, label %arr_alloc97
arr_alloc96:
	call void @throw_oob()
	br label %arr_alloc97
arr_alloc97:
	%_53 = add i32 4, 1
	...
	br i1 %_58, label %arr_alloc98, label %arr_alloc99
arr_alloc98:
	call void @throw_oob()
	br label %arr_alloc99
arr_alloc99:
	%_59 = getelementptr i32, i32* %_57, i32 0
	%_60 = load i32, i32* %_59
	%_61 = icmp sle i32 %_60, 5
	br i1 %_61, label %arr_alloc100, label %arr_alloc101
arr_alloc100:
	call void @throw_oob()
	br label %arr_alloc101
arr_alloc101:
	%_62 = add i32 5, 1
	...
	br i1 %_67, label %arr_alloc102, label %arr_alloc103
arr_alloc102:
	call void @throw_oob()
	br label %arr_alloc103
arr_alloc103:
	%_68 = getelementptr i32, i32* %_66, i32 0
	%_69 = load i32, i32* %_68
	%_70 = icmp sle i32 %_69, 6
	br i1 %_70, label %arr_alloc104, label %arr_alloc105
arr_alloc104:
	call void @throw_oob()
	br label %arr_alloc105
arr_alloc105:
	%_71 = add i32 6, 1
	...
	br i1 %_76, label %arr_alloc106, label %arr_alloc107
arr_alloc106:
	call void @throw_oob()
	br label %arr_alloc107
arr_alloc107:
	%_77 = getelementptr i32, i32* %_75, i32 0
	%_78 = load i32, i32* %_77
	%_79 = icmp sle i32 %_78, 7
	br i1 %_79, label %arr_alloc108, label %arr_alloc109
arr_alloc108:
	call void @throw_oob()
	br label %arr_alloc109
arr_alloc109:
	%_80 = add i32 7, 1
	...
	br i1 %_85, label %arr_alloc110, label %arr_alloc111
arr_alloc110:
	call void @throw_oob()
	br label %arr_alloc111
arr_alloc111:
	%_86 = getelementptr i32, i32* %_84, i32 0
	%_87 = load i32, i32* %_86
	%_88 = icmp sle i32 %_87, 8
	br i1 %_88, label %arr_alloc112, label %arr_alloc113
arr_alloc112:
	call void @throw_oob()
	br label %arr_alloc113
arr_alloc113:
	%_89 = add i32 8, 1
	...
	br i1 %_94, label %arr_alloc114, label %arr_alloc115
arr_alloc114:
	call void @throw_oob()
	br label %arr_alloc115
arr_alloc115:
	%_95 = getelementptr i32, i32* %_93, i32 0
	%_96 = load i32, i32* %_95
	%_97 = icmp sle i32 %_96, 9
	br i1 %_97, label %arr_alloc116, label %arr_alloc117
arr_alloc116:
	call void @throw_oob()
	br label %arr_alloc117
arr_alloc117:
	%_98 = add i32 9, 1
